...
using CGLabProject::MyVirtualWorld;
...
void myKeyboardFunc(unsigned char key, int x, int y)
{
   ...
   case 'k':
   case 'K':
      myvirtualworld.handleKeyInput(key);
      break;
   ...
   case 27:
      ...
      break;
   case 32: // Space key
      myvirtualworld.handleKeyInput(32);
      glutPostRedisplay();
      return;
   }
...
void myLightingInit()
{
   ...
   static GLfloat position[] = {0.0f, 30.0f, -30.0f, 1.0f};
   short shininess = 128;
   ...
   // New second light source (GL_LIGHT1)
   static GLfloat ambient1[] = {0.2f, 0.2f, 0.2f, 1.0f};
   static GLfloat diffuse1[] = {0.8f, 0.8f, 0.8f, 1.0f};
   static GLfloat specular1[] = {1.0f, 1.0f, 1.0f, 1.0f};
   static GLfloat position1[] = {0.0f, 30.0f, 30.0f, 1.0f};
